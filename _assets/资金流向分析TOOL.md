...
| 名称        | 类型  | 描述                                            |
|-----------|-----|-----------------------------------------------|
| symbol    | str | symbol="电源设备" ，东方财富网-数据中心-行业名称                                |
| indicator | str | indicator="今日"; choice of {"今日", "5日", "10日"} |
...
| 名称     | 类型  | 描述            |
|--------|-----|---------------|
| symbol | str | symbol="汽车服务" ，东方财富网-数据中心-行业名称  |
...
| 名称     | 类型  | 描述            |
|--------|-----|---------------|
| symbol | str | symbol="数据要素"，东方财富网-数据中心-概念 |
...
12、接口: stock_hsgt_fund_flow_summary_em
接口中文名：东方财富网-沪深港通资金流向
