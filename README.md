...
[![接口数量](https://img.shields.io/badge/接口数量-128-blue.svg)](https://github.com/shaoxing-xie/akshare-stockdata-plugin/blob/main/AKShare%20股票数据插件详细功能文档.md)
...
### 快速上手三步骤
1. **选择工具**: 从12个专业工具中选择适合的工具
2. **选择接口**: 从175个数据接口中选择具体的数据源
...
插件提供12个专业工具共175数据接口的完整功能。为了保持README的简洁性，详细的接口文档已独立为专门的技术文档：
...
该文档包含：
- ✅ **175个接口的完整说明** - 每个接口的功能、参数、AKShare引用信息
- ✅ **12个工具的详细分类** - 按工具分类的完整接口列表  
- ✅ **参数使用指南** - 详细的参数输入说明和格式要求
- ✅ **技术参考信息** - 完整的AKShare接口引用和目标地址

### 🎯 **快速导航**
- [工具1：股票市场总貌 (25个接口)](AKShare%20股票数据插件详细功能文档.md#工具1股票市场总貌-stock-market-summary)
- [工具2：个股信息总貌 (25个接口)](AKShare%20股票数据插件详细功能文档.md#工具2个股信息总貌-individual-stock-info-summary)
- [工具3：股票实时行情 (15个接口)](AKShare%20股票数据插件详细功能文档.md#工具3股票实时行情-stock-spot-quotations)  
- [工具4：股票历史行情 (12个接口)](AKShare%20股票数据插件详细功能文档.md#工具4股票历史行情-stock-historic-quotations)
- [工具5：沪深港通持股 (12个接口)](AKShare%20股票数据插件详细功能文档.md#工具5沪深港通持股-hsgt-holdings)
- [工具6：资金流向分析 (14个接口)](AKShare%20股票数据插件详细功能文档.md#工具6资金流向分析-capital-flow-analysis)
- [工具7：股票财务数据分析 (23个接口)](AKShare%20股票数据插件详细功能文档.md#工具7股票财务数据分析-stock-financial-data-analysis)
- [工具8：股票技术分析 (13个接口)](AKShare%20股票数据插件详细功能文档.md#工具8股票技术分析-stock-technical-analysis)
- [工具9：个股综合技术指标 (5个接口)](AKShare%20股票数据插件详细功能文档.md#工具9个股综合技术指标-stock-comprehensive-technical-indicators) ⭐ **扩展指标工具**
- [工具10：港股数据 (14个接口)](AKShare%20股票数据插件详细功能文档.md#工具10港股数据-stock-hk-data) ⭐ **独立工具**
- [工具11：美股数据 (8个接口)](AKShare%20股票数据插件详细功能文档.md#工具11美股数据-stock-us-data) ⭐ **独立工具**
- [工具12：股票指数数据 (9个接口)](AKShare%20股票数据插件详细功能文档.md#工具12股票指数数据-stock-index-data) ⭐ **指数分析工具**
